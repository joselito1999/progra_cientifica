...
{
 double a,x,f,re,im,xj[2][2];//Matriz xj para reemplazar las 4 variables del programa anterior, el xre, xim, yre, yim
 int aux;
 ...
 for ( int j = 0; j < N/10; j++ )
 {
  ...
  for ( int i = 0; i < 2; i++ )
   {
    xj[0][i]=0;//Inicializa. El primer índice da la naturaleza, si es real o compleja. 1 es compleja 0 es real. El segundo, 1 es y y 0 es x
    xj[1][i]=0;
   }
  for ( int k = 0; k < N/2; k++ )
  {
