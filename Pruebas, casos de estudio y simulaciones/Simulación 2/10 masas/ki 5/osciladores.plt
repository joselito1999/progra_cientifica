...
set output "10_masas_ki_5_nuevo.png"

#N es el núero de osciladores
N=10

set multiplot layout N/2, 1 title "Osciladores acoplados" font ",24"
set key off
set xlabel "t [1/{/Symbol w}_0]" font "Arial, 24"
set xrange [0:200]
set yrange [-2:2]
set xtics 0,50,600 font "Arial,16"
...
set ylabel "x_{10}" font "Arial, 24"
plot 0 lc rgb "black", "osciladores.dat" u 1:11 with lines lc 11
