...
//Programa para resolver la ecuacion del movimiento de un oscilador armónico amortiguado con el rozamiento proporcional a la velocidad.
//Métodos: euler-cromer, pc, rk2, rk4.
//Ecuación: x"=-k/m*x-g/m*x'
//y1=x, y2=dx/dt, g1= y2, g2= -wo^2 y1-q*x'

//Se trabaja con wo=1 y me define el tiempo en fracciones de periodo. A g/m la llamamos q
//La constante de rozamiento sobre m es una fracción del wo². Pues hay un término de (cte de rozamiento)/m. q<1
...
double x1,v1,x2,v2,x3,v3,x4,v4,x5,v5,xo,vo,wo=1,b,w,a,t,dt,q;

double g2 (double y1, double y2)
{
 double f;
...
int main ()
{
 ...
 for ( int i = 1; i < Nr; i++ ) {
  ...
  file2<< t/T << " "<<xo*cos(t)<<" "<<v1<<" "<<v2<<" "<<v3<<" "<<v4<<endl;
